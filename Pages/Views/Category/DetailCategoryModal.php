...
?>
<div class="modal fade category-modal" id="detailCategoryModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-body">
                <div class="detail-grid">
                    <div class="detail-card">
                        ...
                        <p class="detail-value" id="detailCategoryId">-</p>
                    </div>
                    <div class="detail-card">
                        <span class="detail-label">Estado</span>
                        <p class="detail-value" id="detailCategoryStatus">-</p>
                    </div>
                    <div class="detail-card">
                        <span class="detail-label">Nombre</span>
                        <p class="detail-value" id="detailCategoryName">-</p>
                    </div>
                    <div class="detail-card">
                        <span class="detail-label">Creado</span>
                        <p class="detail-value" id="detailCategoryCreated">-</p>
                    </div>
                    <div class="detail-card">
                        <span class="detail-label">Descripcion</span>
                        <p class="detail-value" id="detailCategoryDescription">-</p>
                    </div>
                    <div class="detail-card">
                        <span class="detail-label">Actualizado</span>
                        <p class="detail-value" id="detailCategoryUpdated">-</p>
                    </div>
                </div>
            </div>
